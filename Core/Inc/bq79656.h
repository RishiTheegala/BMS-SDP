...
typedef enum RequestType {
    ...
    STACK_READ = 0b010,      // stack read
    STACK_WRITE = 0b011,     // stack write
    BROAD_READ = 0b100,      // broadcast read
    BROAD_WRITE = 0b101,     // broadcast write
    BROAD_WRITE_REV = 0b110  // broadcast write reverse
} RequestType;
